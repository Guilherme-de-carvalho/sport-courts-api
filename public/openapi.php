...
// O `vendor/autoload.php` pode emitir avisos (ex.: swagger-php warnings)
// que aparecem antes do JSON. Aqui envolvemos o require em output buffering
// para evitar que esses avisos quebrem a resposta JSON.
ob_start();
